...
const SplashScreen = ({ navigation }) => {
  ...
  return (
    <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center' }}>
        ...
        />
        {/* <View  style={{borderBottomWidth:2, width:'60%', marginTop:'12%', borderColor:'#008389'}}/>
        <View  style={{width:'90%', marginTop:'12%', alignItems:'center'}}>

          <Text style={{fontSize: 15,fontWeight:'bold'}}>{'Created By EdraakSystems'}</Text>
        </View> */}
        ...
        <Image
          style={styles.logo2}
          source={require('../screens/edraakLogo.png')}
        />
